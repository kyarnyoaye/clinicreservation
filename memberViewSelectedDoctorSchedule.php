...
<?php
				...
				?>
                 ...
                 <?php
						...
						include $_SERVER['DOCUMENT_ROOT'].'/clinicreservation/dblink.php';
						$doctorName=$_SESSION['searchDoctorName'];
						$speciality=$_SESSION['searchSpeciality'];
						$gender=$_SESSION['searchGender'];
						$day=$_SESSION['searchDay'];
...
<tr align="center" bgcolor="lightblue">
	 ...
	 ?>
<td style='border: 1px solid #e7ecee;'><a href="memberViewSelectedDoctorDetail.php?doctorId=<?php echo $row['doctorId']; ?>"><span id="viewColor">View Detail</span></a></td>
<?php       
echo "</tr>";                
}
?>
