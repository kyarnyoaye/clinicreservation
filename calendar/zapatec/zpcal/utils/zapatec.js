...
g(v);return a.join('');};Zapatec.Transport.displayError=function(iErrCode,sError,onError){if(typeof onError=='function'){onError({errorCode:iErrCode,errorDescription:sError});}else{//alert(sError);
}};Zapatec.Transport.translateUrl=function(oArg){if(!oArg||!oArg.url){return null;}
