...
$today=date("Y-m-d");
$query="select appointment.*,member.memberName,doctor.doctorName from doctor,appointment,member where appointment.doctorId='".$_SESSION['doctorId']."' and  appointment.doctorId=doctor.doctorId and member.memberId=appointment.memberId and appointment.appointmentDate >= '" . $today . "'"; 
...
<?php
                ...
                <div align="center">
                <br><br>
                <h3><font color="red">No Appointment Information!</font> </h3></div>
                <?php
				}
				?>
