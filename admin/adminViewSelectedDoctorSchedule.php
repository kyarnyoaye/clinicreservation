...
<?php
				...
				?>
                 ...
                 <?php
						...
						include $_SERVER['DOCUMENT_ROOT'].'/clinicreservation/dblink.php';
						$doctorName=$_SESSION['srchDoctorName'];
						$speciality=$_SESSION['srchSpeciality'];
						$gender=$_SESSION['srchGender'];
						$day=$_SESSION['srchDay'];
...
<tr align="center" bgcolor="wheat">
	 ...
	 ?>
<td style='border: 1px solid #e7ecee;'><a href="adminViewSelectedDoctorDetail.php?doctorId=<?php echo $row['doctorId']; ?>"><span id="viewColor">View Detail</span></a></td>
<?php       
echo "</tr>";                
}
?>
